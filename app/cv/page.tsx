...
import { LANGUAGES } from "@/content/data/Languages";
    ...
    <div ref={ref} className="doc">
      ...
      <div className="bg-white p-6">
        <p className="line-clamp-5 text-sm leading-relaxed text-gray-700">
          Front-End Engineer with 5 years of experience with detailed understanding in
          developing modern and responsive interfaces for a wide range of businesses.
          Excellent grasp of React, Nextjs, TS, Redux, Best Practices, Testing, REST and
          GraphQL. Also starting to get more familiarized with ReactNative and Python
        </p>
        {/* Work history */}
        ...
        <div className="mt-4 grid grid-cols-4 gap-y-2">
          ...
          <div className="col-span-3">
            ...
            <ul className="ml-4 list-disc">
              <li className="text-sm leading-normal text-gray-700">
                Already collaborated on multiple projects ranging from responsive landing
                page creation to robust systems with authentication, payment integration,
                and complex state modeling
              </li>
            </ul>
          </div>
          {/* Work #1 */}
          ...
          <div className="col-span-3">
            ...
            <ul className="ml-4 list-disc">
              <li className="text-sm leading-normal text-gray-700">
                Involved in the development of various multi-page sites, and landing pages
                for small and mid-sized businesses. Worked with React, Next.js, HubSpot,
                WordPress and Shopify
              </li>
              <li className="text-sm leading-normal text-gray-700">
                Also worked as a in the development of a health care web app with offline
                capability and complex architecture
              </li>
            </ul>
          </div>
          {/* Work #2 */}
          ...
          <div className="col-span-3">
            ...
            <ul className="ml-4 list-disc">
              <li className="text-sm leading-normal text-gray-700">
                Worked along with the team in the maintenance and development of new
                features for the company&apos;s ERP (Enterprise resource planning) and
                database modeling
              </li>
              <li className="text-sm leading-normal text-gray-700">
                Performed integration with 3rd party APIs (warehouse, stock management,
                e-commerce, etc) and Testing/QA routines
              </li>
            </ul>
          </div>
          {/* Work #3 */}
          ...
          <div className="col-span-3">
            ...
            <ul className="ml-4 list-disc">
              <li className="text-sm leading-normal text-gray-700">
                Evaluate user problems, respond to support requests and patiently walk
