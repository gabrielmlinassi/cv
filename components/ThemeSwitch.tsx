...
export const ThemeSwitch = (props: ComponentProps<"button">) => {
  ...
  if (isFirst)
    return (
      <button {...restProps} className={cn(className, "text-loading")} disabled>
        <Loading />
      </button>
    );
