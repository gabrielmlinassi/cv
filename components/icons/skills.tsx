...
export const JestIcon = () => {
  return (
    ...
    >
      <path
        className="fill-current"
        d="m15.5 6.7 1.6 3.3c-.4.3-.6.8-.7 1.2h-1.8c-.1-.5-.4-.9-.8-1.2l1.7-3.3zm1.8 5.1c0 .9.7 1.6 1.6 1.6.9 0 1.6-.7 1.6-1.6s-.7-1.6-1.6-1.6c-.9.1-1.6.8-1.6 1.6zM13 9.4l2.5-5 2.5 5 .3-.1L20.8 2H10.2l2.5 7.3.3.1zM4.6 21.3c2 1.4 4.1.3 6.6-.9 1.2-.6 2.6-1.2 3.9-1.6l1.5-.2c.9-.2 1.8-.3 2.6-.7.8-.5 1.3-1.2 1.5-2.1.1-.6 0-1.3-.3-1.9-.3.2-.7.4-1.1.4-1.4.2-2.7-.8-2.9-2.2h-1.6c-.2 1.4-1.5 2.4-2.9 2.2-.5.7-.9 1.3-1.6 1.9-.9.9-1.9 1.5-3 1.9H7l-.2-.1c-1.4-.8-2-2.3-1.6-3.7l-.6-.2-.2.4c-.4.9-.9 1.8-1 2.7-.3 1.2-.3 3.1 1.2 4.1zm.9-11c-.9 0-1.6.7-1.6 1.6s.7 1.6 1.6 1.6S7 12.7 7 11.8s-.6-1.5-1.5-1.5zm8.3 1.5c0-.9-.7-1.6-1.6-1.6s-1.6.7-1.6 1.6.7 1.6 1.6 1.6 1.6-.7 1.6-1.6z"
      ></path>
    </svg>
  );
};
...
export const RadixIcon = () => {
  return (
    ...
    >
      ...
      ></path>
      <path className="fill-current" d="M7 0H0V7H7V0Z"></path>
      <path
        className="fill-current"
