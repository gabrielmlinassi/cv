export const LinkedinLink = () => {
  return (
    <a
      className="font-medium dark:bg-gray-8 bg-gray-05 rounded-lg self-start flex items-center justify-center min-h-11 min-w-11 p-2 rounded-1.5 no-underline transition-colors text-secondary-txt leading-none focus:text-[#1471a9] focus:dark:text-[#1da1f2] focus:bg-[#e8f6fe] dark:focus:bg-[#093049]"
      title="LinkedIn"
