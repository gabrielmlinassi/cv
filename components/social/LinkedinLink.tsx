...
type LinkedinLinkProps = {} & VariantProps<typeof linkedinLink>;

export const LinkedinLink = (props: LinkedinLinkProps) => {
  return (
    <a
      className={linkedinLink(props)}
      title="LinkedIn"
