...
const headerItem = tv({
  base: "md:px-3 px-2 py-1 md:py-2 flex items-center md:gap-2 gap-1 border text-sm md:text-base rounded-lg bg-transparent dark:border-[#2c2c2c] border-[#ddd] dark:text-[#bbb] text-[#252525] dark:hover:bg-[#252525] hover:bg-[#f6f6f6]",
  variants: {
    align: { end: "ml-auto" },
