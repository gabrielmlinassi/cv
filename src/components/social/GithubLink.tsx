export const GithubLink = () => {
  return (
    <a
      className="font-medium self-start dark:bg-[#252525] bg-[#f6f6f6] rounded-lg flex items-center justify-center min-h-11 min-w-11 p-2 rounded-1.5 no-underline transition-colors text-secondary-txt bg-transparent hocus:text-[#333] hocus:dark:text-[#ebebeb] hocus:bg-[#ebebeb] dark:hocus:bg-[#333]"
      title="GitHub"
